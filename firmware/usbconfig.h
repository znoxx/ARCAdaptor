 ...
 */
#define USB_CFG_VENDOR_NAME 'h','t','t','p',':','/','/','z','n','o','x','x','.','m','e','/','a','r','c','a','d','a','p','t','o','r'
...
#   define USB_CFG_DEVICE_NAME 'A','r','c','a','d','a','p','t','o','r',' ', '8'
#   define USB_CFG_DEVICE_NAME_LEN 12
#elif defined __AVR_ATmega32__
#   define USB_CFG_DEVICE_NAME 'A','r','c','a','d','a','p','t','o','r',' ','3','2'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH (37 + 33 + (42 * NR_OF_JOYSTICKS) + (52 * USE_MOUSE_DEVICE)) /* total length of report descriptor */
#if USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH > 255
#  error "report descriptor overflow (too many devices defined in avr.h)"
#endif
